...
Grant recipients made a variety of changes to LIHEAP with the increased funding, which more than doubled the typical annual funding available (e.g., increasing benefit amounts to households, or relaxing eligibility criteria to serve more households).<sup>2,3</sup> We are working with ACF and one state grant recipient to examine the effectiveness of a program change to the state’s LIHEAP on home energy stability or stable access to home energy.
