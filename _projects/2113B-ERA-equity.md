...
<img src="{{ '/assets/img/project-images/2113B-fig0.png' | prepend: site.baseurl }}" alt="" width="1500">
<b>Figure 2.</b> <i>Numbers of NEUs that submitted spending reports on Treasury’s ARP Reporting and Compliance Portal</i>
...
Note: height of bars represents estimated proportion of population falling into that demographic category for the ACS, CPS, and Treasury recipient data, respectively. Error bars represent 95% confidence intervals on the difference between the eligible and recipient proportions, calculated through bootstrapped imputation standard errors. 
...
See note on Figure 1. Columns are divided by eligible income brackets; rows by racial and ethnic groups.
