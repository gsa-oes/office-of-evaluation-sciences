...
We are excited to announce that the GSA Office of Evaluation Sciences (OES) is currently accepting applications for two positions based in Washington, D.C.:
 ...
 - **Evidence Fellows Application Now Open - NEW:** OES is uniquely situated at the center of government to share leading practices, develop resources and build skills in the Federal workforce on evidence and evaluation. Six-month details beginning in January 2020 are open to Federal employees. [View solicitation and apply here]({{site.baseurl}}/assets/files/GSA_OES_evidenceactdetailFY20.pdf). Deadline: November 20, 2019. 
