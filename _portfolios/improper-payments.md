...
As part of this portfolio, we have evaluated applications of insights from the social and behavioral sciences to the modification of forms, changes to how and when agencies request information, and changes to communications describing key actions and recommendations. We also developed a guide to help agencies explore whether a "behavioral insights" approach is a good fit for their programs, identify which interventions might work, and implement those program changes.
