...
## Implications
During the four-week study the updated IVR resulted in about 1,400 additional calls to the 988 Suicide and Crisis Lifeline being answered by a counselor. This effect implies that if all calls to 988 are exposed to the updated IVR over a 12-month period, reaching about 5.9 million callers, an additional 36,000 calls would be connected to a counselor. SAMHSA anticipates implementing the updated caller experience for all callers in 2024.
