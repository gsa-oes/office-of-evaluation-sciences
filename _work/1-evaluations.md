...
hide_image: true
tag: work
summary: Since 2015, we have completed over 120 evaluations with dozens of agency partners.
...
<p><a class="usa-button" href="{{ '/projectprocess' | prepend: site.baseurl }}" target="_blank" title="Learn more">Learn more about our project process</a>
</p>
