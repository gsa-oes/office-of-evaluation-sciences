...
The Analysis Plan at the right indicates the date locked, and you can verify our upload date <a href="{{ '/commits/master/assets/analysis/1903-analysis-plan-wildfire.pdf' | prepend: site.baseurl }}">here</a>.
